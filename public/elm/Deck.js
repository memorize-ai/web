...
var author$project$Page$Deck$Model = F3(
	function (user, deck, deckId) {
		return {deck: deck, deckId: deckId, user: user};
	});
var author$project$Page$Deck$SignedOut = {$: 'SignedOut'};
var author$project$Page$Deck$UpdatedDeck = function (a) {
	return {$: 'UpdatedDeck', a: a};
};
var author$project$Page$Deck$UpdatedUser = function (a) {
...
var author$project$Page$Deck$signedOut = _Platform_incomingPort(
	'signedOut',
...
var author$project$Page$Deck$updateDeck = _Platform_incomingPort(
	'updateDeck',
	A2(
													...
													return A2(
														...
														function (count) {
															return elm$json$Json$Decode$succeed(
																{count: count, creator: creator, description: description, name: name, owner: owner, photoUrl: photoUrl, _public: _public});
														},
...
var author$project$Page$Deck$updateUser = _Platform_incomingPort(
	'updateUser',
	A2(
		elm$json$Json$Decode$andThen,
		function (uid) {
...
var author$project$Page$Deck$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Page$Deck$updateUser(author$project$Page$Deck$UpdatedUser),
				author$project$Page$Deck$updateDeck(author$project$Page$Deck$UpdatedDeck),
				author$project$Page$Deck$signedOut(
				elm$core$Basics$always(author$project$Page$Deck$SignedOut))
			]));
};
var elm$json$Json$Encode$null = _Json_encodeNull;
var author$project$Page$Deck$signOut = _Platform_outgoingPort(
	'signOut',
	function ($) {
...
var author$project$Page$Deck$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UpdatedUser':
				var user = msg.a;
			...
			case 'SignOut':
				return _Utils_Tuple2(
					model,
					author$project$Page$Deck$signOut(_Utils_Tuple0));
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Page$Deck$SignOut = {$: 'SignOut'};
...
var author$project$Page$Deck$loadingOrHtml = F2(
	function (htmlFunc, maybe) {
		return A2(
			...
			A2(elm$core$Maybe$map, htmlFunc, maybe));
	});
var author$project$Page$Deck$loadingOrString = elm$core$Maybe$withDefault('Loading...');
var author$project$Page$Deck$loadingOrText = function (textMaybe) {
	return A2(
		elm$core$Maybe$withDefault,
		A2(
			elm$html$Html$i,
...
var author$project$Page$Deck$viewDeck = function (deck) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$text(deck.creator)
													])),
												elm$html$Html$text(' '),
												A2(
												elm$html$Html$small,
												...
												_List_fromArray(
													[
														elm$html$Html$text(
														elm$core$String$fromInt(deck.count))
													]))
											]))
									]))
							]))
...
var author$project$Page$Deck$view = function (model) {
	return {
		body: A3(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															author$project$Page$Deck$loadingOrText(
															A2(
																elm$core$Maybe$map,
																function (deck) {
													...
													A2(author$project$Page$Deck$loadingOrHtml, author$project$Page$Deck$viewDeck, model.deck)
												]))
										])),
									A2(
									elm$html$Html$div,
			...
			model.user,
			author$project$Page$Deck$SignOut),
		title: author$project$Page$Deck$loadingOrString(
			A2(
				elm$core$Maybe$map,
				function ($) {
					return $.name;
				},
				model.deck)) + ' Deck - memorize.ai'
	};
};
...
var author$project$Page$Deck$main = elm$browser$Browser$document(
	{
		init: function (deckId) {
			return _Utils_Tuple2(
				A3(author$project$Page$Deck$Model, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing, deckId),
				elm$core$Platform$Cmd$none);
		},
		subscriptions: author$project$Page$Deck$subscriptions,
		update: author$project$Page$Deck$update,
		view: author$project$Page$Deck$view
	});
_Platform_export({'Page':{'Deck':{'init':author$project$Page$Deck$main(elm$json$Json$Decode$string)(0)}}});}(this));