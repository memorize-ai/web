...
const Privacy = () => (
	...
	>
		...
		<br />
		<br />
		Thank you for choosing to be part of our community at memorize.ai
		...
		information, please contact us at support@memorize.ai.
		<br />
		<br />
		When you visit our mobile application, and use our services, you trust us
		with your personal information. We take your privacy very seriously. In this
		...
		<br />
		<br />
		In Short: We may collect information regarding your mobile device, when you
		use our apps.
		<br />
		<br />
		...
		<br />
		<br />
		We use personal information collected via our Apps for a variety of business
		...
		Apps, products, marketing and your experience. We may use and store this
		information in aggregated and anonymized form so that it is not associated
		with individual end users and does not include personal information. We will
		...
		the Apps, which will enable them to collect data about how you interact with
		the Apps over time. This information may be used to, among other things,
		analyze and track data, determine the popularity of certain content and
		better understand online activity. Unless described in this Policy, we do
		not share, sell, rent or trade any of your information with third parties
		...
		serve ads when you visit the Apps. These companies may use information about
		...
		Apps is at your own risk. You should only access the services within a
		secure environment.
		<br />
		<br />
		...
		under age 18, please contact us at support@memorize.ai.
		<br />
		<br />
		...
		our Apps. To opt-out of interest-based advertising by advertisers on our
		Apps visit http://www.aboutads.info/choices/.
		<br />
		<br />
		...
		unwanted data that you publicly post on the Apps. To request removal of such
		...
		support@memorize.ai or by post to:
		<br />
		<br />
		memorize.ai
		<br />
